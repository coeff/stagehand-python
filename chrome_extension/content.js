...
// Extension-specific: Mark that Stagehand scripts are loaded
if (typeof window !== 'undefined') {
  window.__stagehandExtensionLoaded = true;
  console.log('[Stagehand Content] DOM scripts loaded successfully');
}

// Listen for messages from background script
if (typeof chrome !== 'undefined' && chrome.runtime) {
  chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
    if (message.type === 'STAGEHAND_PING') {
